...
let os, path, Emitter, StateController, AccountManager, Logger, Installation,
  ...
  promisifyRequest, localconfig, errors, flatten, compact, DataLoader, BrowserClient, NodeClient;

const ensureKiteDeps = () => {
  if (!StateController) {
    ({
      BrowserClient, StateController, AccountManager, Logger, Installation, Installer, Errors, Metrics, NodeClient,
