...
function openDocumentationInWebURL(id) {
  return `http://localhost:46624/clientapi/desktoplogin?d=/docs/python/${escapeId(id)}`;
}

function openSignatureInWebURL(id) {
  return `http://localhost:46624/clientapi/desktoplogin?d=/docs/python/${escapeId(id)}%23signature`;
}
