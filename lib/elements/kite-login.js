    ...
    this.innerHTML = `
      <form>
        ...
        <div>
          ...
          <button type="submit" class="submit btn btn-primary inline-block  has-password">
            <span class="for-login">Sign into Kite</span><span class="for-signup">Create account</span>
          </button>
