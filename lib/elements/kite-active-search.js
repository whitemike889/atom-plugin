...
const {promisifyReadResponse, addDelegatedEventListener, DisposableEvent, compact, flatten, parent} = require('../utils');
require('./kite-expand');
...
class KiteActiveSearch extends HTMLElement {
  ...
  createdCallback() {
    ...
    //this.hintView = this.querySelector('.hint');
  ...
  clear() {
    ...
    if (this.historyView) {
      ...
      <p class="grim">
        Type any identifier above to search docs, popular patterns, signatures and more.
      </p>
