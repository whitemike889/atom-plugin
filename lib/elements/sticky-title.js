...
module.exports = class StickyTitle {
  constructor(stickies, scrollContainer) {
    ...
    if (atom.views.pollDocument) {
      ...
      elementResizeDetector.listenTo(this.scrollContainer, measureDimensions);
      this.subscriptions.add(new Disposable(() => { elementResizeDetector.removeListener(this.scrollContainer, measureDimensions); }));
