...
class KiteAutocorrectSidebar extends HTMLElement {
    ...
    this.innerHTML = `
      <div class="kite-column">
        ...
        <div class="settings-view">
          <a href="http://help.kite.com" title="Learn about automatic code clean-up" class="icon icon-question"></a>
  ...
  showFirstRunExperience() {
    this.appendMessage(`<h4>Kite just fixed your code for the first time</h4>
    <p>
    ...
    <a href="http://help.kite.com">Learn about automatic code clean-up</a>`);
  }
