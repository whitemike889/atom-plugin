...
class KiteStatusPanel extends HTMLElement {
  ...
  renderLinks(account) {
    ...
    <ul class="links ${account ? 'has-account' : 'no-account'}">
      <li><a class="icon icon-search" href="http://localhost:46624/clientapi/desktoplogin?d=/docs" class="account-dependent">Kite Web Search</a></li>
    ...
    <ul class="links ${account ? 'has-account' : 'no-account'}">
      ...
      <li><a class="icon icon-file-directory" href="http://localhost:46624/settings/permissions" class="account-dependent">Kite Permissions</a></li>
    </ul>
    </kite-links>
    `;
  }
