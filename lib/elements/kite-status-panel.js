  ...
  renderLinks(plan) {
    ...
    <ul class="links">
      ...
      <li><a is="kite-localtoken-anchor"
         href="http://local.kite.com:46624/settings">Settings</a></li>
    ...
    switch (status) {
      ...
      case STATES.AUTHENTICATED:
        ...
        if (!editor || (editor && (!this.app.isGrammarSupported(editor) ||
          ...
          const settingsURL = `http://local.kite.com:46624/settings/permissions?filename=${path}`;
          content = `
    ...
    if (!Plan.isPro() && Plan.isActive()) {
      ...
      if (Plan.hasStartedTrial()) {
        rightSide = `<a is="kite-localtoken-anchor"
                     href="http://local.kite.com:46624/redirect/pro">Upgrade</a>`;
      } else {
        rightSide = `<a is="kite-localtoken-anchor"
                     href="http://local.kite.com:46624/redirect/trial">Start Pro trial</a>`;
      }
    } else if (Plan.isPro()) {
      ...
      if (Plan.isTrialing()) {
        ...
        rightSide = `<a is="kite-localtoken-anchor"
                        href="http://local.kite.com:46624/redirect/pro">Account</a>`;
      }
    }
