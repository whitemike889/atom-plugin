  ...
  return symbol.report && symbol.report.usages && symbol.report.usages.length
    ? section('Examples from your code',
      Plan.can('usages_editor')
        ...
        : proFeatures(`To see ${symbol.report.usages.length}
            ${pluralize(symbol.report.usages.length, 'example', 'examples')}`),
      { help: `<a href="https://help.kite.com/article/58-why-kite-is-cloud-powered"
          title="This section is visible just to you.<br><br>Click to learn more."
