  ...
  switch (detail.language) {
    case 'python':
      return [
        ...
        detail ? detail.language_details.vararg : null,
        detail ? detail.language_details.kwarg : null,
      ];
    case 'javascript':
      return [
        detail ? detail.parameters : null,
        detail ? detail.language_details.rest : null,
      ];
    default:
      return [
        detail ? detail.parameters : null,
...
function renderLanguageSpecificArguments(detail) {
  switch (detail.language) {
    case 'python':
      return [
        renderParameter(detail.language_details.vararg, '*'),
        renderParameter(detail.language_details.kwarg, '**'),
      ].join('');
    case 'javascript':
      return [
        renderParameter(detail.language_details.rest, '…'),
      ].join('');
    default:
      return '';
  }
