  ...
  switch (detail.language) {
    case 'python':
      return [
        ...
        detail ? detail.language_details.Python.vararg : null,
        detail ? detail.language_details.Python.kwarg : null,
      ];
    case 'javascript':
      return [
        detail ? detail.parameters : null,
        detail ? detail.language_details.Javascript.rest : null,
      ];
    default:
      return [
        detail ? detail.parameters : null,
...
function renderLanguageSpecificArguments(detail) {
  switch (detail.language) {
    case 'python':
      return [
        renderParameter(detail.language_details.Python.vararg, '*'),
        renderParameter(detail.language_details.Python.kwarg, '**'),
      ].join('');
    case 'javascript':
      return [
        renderParameter(detail.language_details.Javascript.rest, '…'),
      ].join('');
    default:
      return '';
  }
