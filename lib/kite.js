  ...
  patchCompletions() {
    ...
    .then(autocompletePlus => {
      ...
      if (safeDisplay) {
        ...
        const safeUpdateUI = listElement.updateUIForChangedProps;
        listElement.updateUIForChangedProps = () => {
          safeUpdateUI.call(listElement);
        };
        ...
        manager.displaySuggestions = (suggestions, options) => {
          if (element.querySelector('kite-signature')) {
            element.classList.add('with-kite-signature');
            ...
            element.classList.remove('with-kite-signature');
          }
        };
