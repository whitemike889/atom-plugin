...
let child_process, CompositeDisposable, TextEditor, AccountManager,
  ...
  addDelegatedEventListener, ERROR_RESCUE_SHOW_SIDEBAR, VirtualCursor;

const Kite = module.exports = {
  activate() {
    // const sessionCounter = parseInt(localStorage.getItem('kite.sessionCounter') || '0', 10);
    // localStorage.setItem('kite.sessionCounter', sessionCounter + 1);
    //
    // if (sessionCounter === 0) {
    //   console.log('first window');
    // } else {
    //   console.log(`window #${sessionCounter + 1}`);
    // }
  ...
  deactivate() {
    ...
    // if (localStorage.getItem('kite.sessionCounter')) {
    //   const sessionCounter = parseInt(localStorage.getItem('kite.sessionCounter'), 10);
    //   localStorage.setItem('kite.sessionCounter', sessionCounter - 1);
    //
    //   if (sessionCounter === 1) {
    //     console.log('last window');
    //   } else {
    //     console.log(`window #${sessionCounter}`);
    //   }
    // }
  },
  ...
  errorRescueVersion() {
    const version = localStorage.getItemItem('kite.autocorrect_model_version');
