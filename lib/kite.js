...
const Kite = module.exports = {
  activate() {
    ...
    if (!AccountManager) {
      ...
      KiteExpandAtCursorHighlight = require('./elements/kite-expand-at-cursor-highlight');
  ...
  expandAtCursor(editor) {
    ...
    this.lastExpandAtCursorHighlight = new KiteExpandAtCursorHighlight();
    this.lastExpandAtCursorHighlight.activate(editor, position);
  ...
  getLastExpandAtCursorHighlight() {
    return this.lastExpandAtCursorHighlight;
  },
