...
module.exports = {
  activate() {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      ...
      'kite:install': () => this.app.showInstallFlow({}),
      ...
      'kite:test-autocorrect-ui': () => {
        ...
        Kite.autocorrectSidebar.innerHTML = `
        ...
        <div class="kite-column">
          ...
          <div class="content">
            <div class="file">Corrections in errored.py</div>
            <div class="diffs">
              <div class="diff">
                <div class="timestamp">
                  Fixed 1 error on Tue Jan 30 2018 16:26:51 GMT+0100 (CET)
                </div>
                <code class="diff-content">
                  <del>
                    <div class="line-number">0</div>
                    <div class="line">for x in list</div>
                  </del><ins>
                    <div class="line-number">0</div>
                    <div class="line">for x in list:</div>
                  </ins>
  ...
  consumeStatusBar(statusbar) {
    statusbar.addRightTile({item: this.getAutocorrectStatusItem()});
  ...
  getAutocorrectStatusItem() {
    if (this.autocorrectStatus) { return this.autocorrectStatus; }
    if (!KiteAutocorrectStatus) { KiteAutocorrectStatus = require('./elements/kite-autocorrect-status'); }

    this.autocorrectStatus = new KiteAutocorrectStatus();
    this.autocorrectStatus.Kite = this;
    return this.autocorrectStatus;
  },
