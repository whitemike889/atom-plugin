...
const Kite = module.exports = {
  ...
  startupNotifications() {
    ...
    this.notificationQueue.add(() => {
      ...
      metrics.sendFeatureMetric('atom_editor_vacancy_notification_requested');
      ...
      .then(({plugins}) => {
        ...
        const buttons = [{
          text: 'Show me',
          onDidClick(dismiss) {
            metrics.sendFeatureMetric('atom_editor_vacancy_notification_install_requested');
            atom.applicationDelegate.openExternal('kite://settings/plugins');
            metrics.sendFeatureMetric('atom_editor_vacancy_notification_install_fulfilled');
            dismiss();
          },
        }, {
          text: 'Never ask again',
          onDidClick(dismiss) {
            metrics.sendFeatureMetric('atom_editor_vacancy_notification_disabled_requested');
            atom.config.set('kite.showEditorVacanciesNotificationOnStartup', false);
            metrics.sendFeatureMetric('atom_editor_vacancy_notification_disabled_fulfilled');
            dismiss();
          },
        }];
        ...
        metrics.sendFeatureMetric('atom_editor_vacancy_notification_fulfilled');
...
Would you like to install Kite for these editors?`,
    ...
    this.notificationQueue.addModal({
      ...
      onDidDismiss: res => {
        ...
        if (!res) {
          metrics.sendFeatureMetric('atom_editor_vacancy_notification_dismiss_requested');
          metrics.sendFeatureMetric('atom_editor_vacancy_notification_dismiss_fulfilled');
        }
      },
    });
  },
