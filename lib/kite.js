...
const KiteActiveSearch = require('./elements/kite-active-search');
...
module.exports = {
  activate() {
    ...
    const paneContainer = document.querySelector('atom-pane-container.panes');

    paneContainer.appendChild(this.getSearchItem());
