  ...
  switch (lang) {
    ...
    case 'javascript':
      return detailNotEmpty(p, 'default_value')
        ? `<span class="syntax--python syntax--keyword syntax--operator syntax--assignment">=</span><span class="syntax--python parameter-default">${head(detailGet(p, 'default_value')).repr}</span>`
        : '';
    default:
      return '';
  }
